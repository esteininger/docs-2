...
<Note>
**For self-hosted, EU, and AWS US SaaS**

Update the LangSmith URL in the requests below for self-hosted installs, the EU region (`eu.api.smith.langchain.com`), or AWS-hosted US SaaS (`aws.api.smith.langchain.com`).
</Note>
