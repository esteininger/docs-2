...
client = ls.Client(
    ...
    api_url="https://api.smith.langchain.com",  # Self-hosted, EU (`eu.api...`), or AWS US (`aws.api...`) as needed
)
...
const client = new Client(
    {
        apiKey: "YOUR_API_KEY",
        apiUrl: "https://api.smith.langchain.com", // Self-hosted, EU (`eu.api...`), or AWS US (`aws.api...`) as needed
    }
);
