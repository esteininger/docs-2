...
<Tabs>
  ...
  **External MongoDB** (production):
  ...
  <Tab title="Cloud">
  Add `LS_MONGODB_URI` as an environment variable in your deployment settings in the LangSmith UI.
  ...
  <Tab title="Hybrid">
  Set `LS_MONGODB_URI` as an environment variable through the control plane. Your MongoDB instance must be reachable from your data plane Kubernetes cluster.
  </Tab>
</Tabs>
