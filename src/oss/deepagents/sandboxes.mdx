...
Sandboxes consume resources and cost money until they're shut down. How you manage their lifecycle depends on your application. The key decision is how long a sandbox lives and how it maps to your application's resources.
...
For production deployment patterns including client-side invocation examples, see [going to production](/oss/deepagents/going-to-production#sandboxes).
