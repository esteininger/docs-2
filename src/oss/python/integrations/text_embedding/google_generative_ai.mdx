---
title: "Google Generative AI (Gemini API) integration"
...
To use Google Generative AI models, you must have an API key. You can create one in Google AI Studio. See the [Gemini API keys documentation](https://ai.google.dev/gemini-api/docs/api-key) for instructions.
...
embeddings = GoogleGenerativeAIEmbeddings(
    ...
    output_dimensionality=756,  # Suggested: 756, 1536, or 3072 (default)
)
vector = embeddings.embed_query("hello, world!")
len(vector)
```
