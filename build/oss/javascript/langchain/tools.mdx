...
<Info>
    See [Headless tools](/oss/javascript/langchain/frontend/headless-tools) for an end-to-end example that shows how to register client-side implementations with `useStream`.
</Info>
