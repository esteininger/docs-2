...
LangChain and [Deep Agents](/oss/javascript/langchain/overview) provide prebuilt middleware for common use cases. Each middleware is production-ready and configurable for your specific needs.
...
`FilesystemMiddleware` from [deep agents](/oss/javascript/langchain/overview) provides four tools for interacting with both short-term and long-term memory:
...
The subagents middleware from [deep agents](/oss/javascript/langchain/overview) allows you to supply subagents through a `task` tool.
