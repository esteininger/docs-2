...
See the [Quickstart](/oss/javascript/langchain/quickstart/) and [Customization guide](/oss/javascript/deepagents/customization/) to get started.
...
See the [Installation instructions](/oss/javascript/langchain/quickstart) and [Quickstart guide](/oss/javascript/langchain/quickstart) to get started with LangChain.
...
<CardGroup cols={2}>
    <Card title="Agents Quickstart" icon="rocket" href="/oss/javascript/langchain/quickstart">
