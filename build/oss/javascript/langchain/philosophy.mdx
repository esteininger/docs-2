...
Today developers can choose how they build agents: [LangChain](/oss/javascript/langchain/overview) for flexibility and control, or [Deep Agents](/oss/javascript/langchain/overview) for a batteries-included experience with built-in planning, filesystem tools, subagents, and context management. Both are built on [LangGraph](/oss/javascript/langgraph/overview).
