...
In addition to [built-in tools](/oss/javascript/langchain/overview#core-capabilities) for planning, file management, and subagent spawning, you can provide custom tools:
...
You can use [skills](/oss/javascript/langchain/overview) to provide your deep agent with new capabilities and expertise.
