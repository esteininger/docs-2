...
The [Deep Agents SDK](/oss/python/langchain/overview) builds on top of LangGraph and adds planning capabilities, file systems for context management, the ability to spawn subagents, and more.
...
Use the [Deep Agents SDK](/oss/python/langchain/overview) when:
...
| Streaming | [Agent Streaming](/oss/python/langchain/streaming) | [Streaming](/oss/python/langgraph/streaming) | [Streaming](/oss/python/deepagents/streaming) |

## Learn more

- [LangChain overview](/oss/python/langchain/overview)
- [LangGraph overview](/oss/python/langgraph/overview)
- [Deep Agents overview](/oss/python/langchain/overview)
