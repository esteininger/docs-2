...
In addition to [built-in tools](/oss/python/langchain/overview#core-capabilities) for planning, file management, and subagent spawning, you can provide custom tools:
...
You can use [skills](/oss/python/langchain/overview) to provide your deep agent with new capabilities and expertise.
