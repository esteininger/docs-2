...
[Deep agents](/oss/python/langchain/overview) include built-in functionality for managing context, a virtual filesystem, and other common agent requirements.
