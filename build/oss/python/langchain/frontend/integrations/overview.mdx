...
All three work with any `@langchain/react`-compatible agent: [`create_agent`](https://reference.langchain.com/python/langchain/agents/factory/create_agent), [`create_deep_agent`](https://reference.langchain.com/python/deepagents/graph/create_deep_agent), or a custom [LangGraph](/oss/python/langgraph/overview) graph.
