...
1. In your IdP: Configure a SAML application with the following details, then copy the metadata URL or XML for step 3.
   ...
   <Note>
   The following URLs depend on whether your organization is on the US (GCP), EU (GCP), or AWS (US) cloud region. Ensure you select the correct link.
   </Note>
